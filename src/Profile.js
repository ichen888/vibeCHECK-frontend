                ...
                {showPopup && (
                    <div className="popup-overlay" onClick={handlePopupClose}>
                        <div className="popup-content" onClick={(e) => e.stopPropagation()}>
                            ...
                            <p>
                                The goal of this project is to create VibeCHECK, a web-based application designed to provide audiences with a transparent and data-driven view of how their favorite celebrities are perceived in terms of "vibes" or public sentiment. By aggregating and analyzing data from TMZ news articles, YouTube comments, and user votes, the platform generates a comprehensive VibeScore for each celebrity. This score reflects public perception across multiple dimensions, including news sentiment, video sentiment, and audience feedback.
                            </p>
                            <p>
