import "./ButtonVariantSubtleStateDefaultSizeMedium.css";
...
export const ButtonVariantSubtleStateDefaultSizeMedium = ({
  hasIconStart = false,
  ...
  return (
    <div
      className={
        "button-variant-subtle-state-default-size-medium " +
        className +
        " " +
        variantsClassName
      }
